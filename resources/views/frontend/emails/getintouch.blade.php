                          ...
                          <tbody>
                            <tr>
                              <td style="width:180px;">
                                <img alt="" height="auto" src="https://karir.sadhanas.co.id/frontend/assets/img/logo1.png" style="border:none;display:block;outline:none;text-decoration:none;height:auto;width:100%;font-size:13px;" width="180" />
                              </td>
                            </tr>
                          </tbody>
                        </table>
                  ...
                  <tbody>
                    <tr>
                      <td align="center" style="font-size:0px;padding:10px 25px;padding-top:28px;padding-right:25px;padding-bottom:18px;padding-left:25px;word-break:break-word;">
                        <div style="font-family:Ubuntu, Helvetica, Arial, sans-serif;font-size:13px;line-height:1;text-align:center;color:#FFFFFF;">HELLO <p style="font-size:16px; color:white; text-align:center">{{ $data['name'] }}</p>
                        </div>
                      </td>
                    </tr>
                  </tbody>
                  ...
                  <tbody>
                    ...
                    <tr>
                      <td align="center" style="font-size:0px;padding:10px 25px;padding-top:28px;padding-right:25px;padding-bottom:28px;padding-left:25px;word-break:break-word;">
                        <div style="font-family:Helvetica;font-size:13px;line-height:1;text-align:center;color:#FFFFFF;"><span style="font-size:20px; font-weight:bold">Thank you for contacting us.</span>
                          <br />
                          <span style="font-size:15px">our representative will get back to you soon!</span>
                        </div>
                      </td>
                    </tr>
                  </tbody>
